...
public class FloatingActionButton extends View {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (null != drawable) {
            ...
            final int bWidth = getWidth() - getPaddingLeft() - getPaddingRight();
            final int bHeight = getHeight() - getPaddingTop() - getPaddingBottom();
            Timber.d("width: "+ bWidth);
            Timber.d("height: "+ bHeight);
            mBitmap = Bitmap.createScaledBitmap(mBitmap, bWidth, bHeight, true);
